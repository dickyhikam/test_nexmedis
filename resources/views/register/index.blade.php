                ...
                <div class="login-card login-dark">
                    <div>
                        ...
                        <div class="login-main">
                            <form class="theme-form" action="{{ url('/action_register') }}" method="POST">
                                {{ csrf_field() }}
                                <h2 class="text-center">Create your account</h2>
                                <p class="text-center">Enter your personal details to create account</p>
                                <div class="form-group">
                                    <label class="col-form-label">First Name<c style="color: red;">*</c></label>
                                    <input class="form-control @error('first') is-invalid @enderror" placeholder="First name" name="first" id="first" value="{{ old('first') }}">
                                    @error('first')
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">Last Name<c style="color: red;">*</c></label>
                                    <input class="form-control @error('last') is-invalid @enderror" placeholder="Last name" name="last" id="last" value="{{ old('last') }}">
                                    @error('last')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" type="email" placeholder="Test@gmail.com" name="email" id="email" value="{{ old('email') }}">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <p class="mt-4 mb-0 text-center">Already have an account?<a class="ms-2" href="{{ url('/') }}">Sign in</a></p>
                            </form>
                        </div>
                    </div>
                </div>
